  ...
  "When an invalid user logs in, notAuthorised" should {
    "redirect to the authenticaiton page " in new SetUp {
      ...
      redirectLocation(result).get shouldBe
        "http://localhost:9025/gg/sign-in?continue=http://localhost:9233/payrollbik/payrolled-benefits-expenses&continue=http%3A%2F%2Flocalhost%3A9233%2Fpayrollbik%2Fpayrolled-benefits-expenses&origin=pbik-frontend"
