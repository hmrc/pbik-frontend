...
//import models._
//import models.v1.exclusion.{ExclusionResponse, PbikExclusionPerson, PbikExclusions}
...
//      .getRegisteredBiks(any(), argEq(year))(
//        any(),
...
//  when(
//    mockExclusionListController.tierConnector
//      .getRegisteredBiks(any(), anyInt())(any(), any[AuthenticatedRequest[_]])
//  ).thenReturn(
//    Future.successful(
//      BikResponse(
//        responseHeaders,
...
//  when(
//    mockExclusionListController.tierConnector
//      .excludeEiLPersonFromBik(any(), anyInt(), any())(
//        any(),
//        any[Request[_]]
//      )
//  ).thenReturn(Future.successful(ExclusionResponse(OK, null)))
//
...
//        when(
//          mockExclusionListController.tierConnector
//            .removeEiLPersonExclusionFromBik(argEq(iabdString), any(), anyInt(), any())(
//              any(),
//              any[Request[_]]
//            )
...
//        when(
//          mockExclusionListController.tierConnector
//            .excludeEiLPersonFromBik(argEq(iabdString), any(), anyInt(), argEq(eilPerson))(
//              any(),
//              any[Request[_]]
//            )
